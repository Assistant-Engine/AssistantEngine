...
function toastTest() {
  if (typeof toastr === 'undefined') {
    console.error('toastr not found on this page.');
    return;
  }

  // Lock all toasts so they stay
  ...
  // Re-show existing ones if any
  $('.toast').each(function () {
    $(this).stop(true, true).show().css('opacity', 1);
  });

  // Create examples of all toast types
  toastr.info('This is an info toast – usually used for general updates.', 'Info');
  toastr.success('This is a success toast – great job!', 'Success');
  toastr.warning('This is a warning toast – proceed with caution.', 'Warning');
  toastr.error('This is an error toast – something went wrong.', 'Error');

  console.log('All toastrs now stay visible, and sample toasts shown.');
}
